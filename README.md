...
* [xlate/staedi](https://github.com/xlate/staedi) ⭐ 150 | 🐛 7 | 🌐 Java | 📅 2026-09-22 - General X12/EDIFACT stream reader and writer with support for validation of standards with optional schema customizations (i.e. implementation guides)
...
* [Odoo](https://github.com/odoo/odoo) ⭐ 54,513 | 🐛 10,443 | 🌐 Python | 📅 2026-09-22 - Odoo. Open Source Apps To Grow Your Business.
...
* [hellooops/Edi Support](https://github.com/hellooops/vscode-edi-support) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-30 - Visual Studio Code extension providing language support for X12/HIPAA and EDIFACT
