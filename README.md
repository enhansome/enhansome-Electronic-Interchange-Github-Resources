...
* [xlate/staedi](https://github.com/xlate/staedi) ⭐ 150 | 🐛 7 | 🌐 Java | 📅 2026-09-21 - General X12/EDIFACT stream reader and writer with support for validation of standards with optional schema customizations (i.e. implementation guides)
...
* [nerdocs/pydifact](https://github.com/nerdocs/pydifact) ⭐ 191 | 🐛 7 | 🌐 Python | 📅 2026-09-21 - A python library for parsing EDIFACT messages
...
* [irobayna/stupidedi](https://github.com/irobayna/stupidedi) ⭐ 292 | 🐛 29 | 🌐 Ruby | 📅 2026-09-16 - Ruby API for parsing and generating ASC X12 EDI transactions.
...
* [moov-io/x12](https://github.com/moov-io/x12) ⭐ 21 | 🐛 4 | 🌐 Go | 📅 2026-09-19 - ASC X12 standards reader/writer
...
* [Odoo](https://github.com/odoo/odoo) ⭐ 54,494 | 🐛 10,453 | 🌐 Python | 📅 2026-09-21 - Odoo. Open Source Apps To Grow Your Business.
* [nextgenhealthcare](https://github.com/nextgenhealthcare/connect) ⭐ 1,202 | 🐛 411 | 🌐 Java | 📅 2026-09-17 - The swiss army knife of healthcare integration.
* [blueseerERP/blueseer](https://github.com/blueseerERP/blueseer) ⭐ 169 | 🐛 5 | 🌐 Java | 📅 2026-09-19 - A Free ERP and EDI solution for the manufacturing community.
* [OCA/edi](https://github.com/OCA/edi) ⭐ 142 | 🐛 65 | 🌐 Python | 📅 2026-09-16 - EDI Modules for Ooda
...
* [Healthcare-Data-Insight/api-examples](https://github.com/Healthcare-Data-Insight/api-examples) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - X12 EDI Converter API and Java parser usage examples
